...
The desktop UI features switchable Overview/Detail modes for blocs, policies, milestones, and the sidebar, collapsible sections, dynamic resource bar coloring, a milestone tracker with condition checklists, and a guided 14-step tutorial with spotlight highlighting. Fully responsive for mobile with a 5-tab layout.
